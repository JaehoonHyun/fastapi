...
KEYCLOAK_BASE_URL = "http://hooneyo.xtrm-istio.io"
AUTH_URL = (
    f"{KEYCLOAK_BASE_URL}/auth/realms/keycloak-demo"
    "/protocol/openid-connect/auth?client_id=app&response_type=code"
)
TOKEN_URL = (
    f"{KEYCLOAK_BASE_URL}/auth/realms/keycloak-demo/protocol/openid-connect/token"
)
...
async def root(request: Request,) -> Dict:
    ...
    #pyJWT >= 2.0.0 버전은 fail, 1.7.1로 설치
    decoded = jwt.decode(
